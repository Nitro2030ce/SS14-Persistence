research-tree-label-selected = Selected:
research-tree-label-cost = Cost:
research-tree-label-reqs = Requirements:
research-tree-label-unlocks = Unlocks:
research-tree-button-research = Research
research-tree-button-remove-queue = Remove from queue
research-tree-button-researched = Researched
research-tree-label-progress = Research progress: {$progress}/{$required}
